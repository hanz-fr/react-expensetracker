  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="chart-bar mx-auto">
        <div className="bg-[#00CCBF] overflow-hidden transition-all duration-500" role="progressbar" style={{ height: "25%" }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
      </div>
